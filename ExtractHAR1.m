function [ SW_in, WindSpeed, Temp, Precip, Pressure, Humidity, Emissivity, LW_in, stTime, Data ] = ExtractHAR1( Lat, Long, sFileDir )
...
cd(sFileDir)
% LW_in = zeros(Length, 1);
% SW_in = zeros(Length, 1);
% WindSpeed = zeros(Length, 1);
% Temp = zeros(Length, 1);
% Precip = zeros(Length, 1);
% SpecHumidity = zeros(Length, 1);
% Pressure = zeros(Length, 1);
% Cloudiness = zeros(Length, 1);
...
for i = 0:14
    ...
    if i < 10
        sFileName = ['har_d10km_h_2d_lwdown_200', num2str(i), '.nc'];
    else
        sFileName = ['har_d10km_h_2d_lwdown_20', num2str(i), '.nc'];
    end
...
for i = 0:14
    ...
    if i < 10
        sFileName = ['har_d10km_h_2d_swdown_200', num2str(i), '.nc'];
    else
        sFileName = ['har_d10km_h_2d_swdown_20', num2str(i), '.nc'];
    end
...
for i = 0:14
    ...
    if i < 10
        sFileName = ['har_d10km_h_2d_ws10_200', num2str(i), '.nc'];
    else
        sFileName = ['har_d10km_h_2d_ws10_20', num2str(i), '.nc'];
    end
...
for i = 0:14
    ...
    if i < 10
        sFileName = ['har_d10km_h_2d_prcp_200', num2str(i), '.nc'];
    else
        sFileName = ['har_d10km_h_2d_prcp_20', num2str(i), '.nc'];
    end
...
for i = 0:14
    ...
    if i < 10
        sFileName = ['har_d10km_h_2d_psfc_200', num2str(i), '.nc'];
    else
        sFileName = ['har_d10km_h_2d_psfc_20', num2str(i), '.nc'];
    end
...
for i = 0:14
    ...
    if i < 10
        sFileName = ['har_d10km_h_2d_q2_200', num2str(i), '.nc'];
    else
        sFileName = ['har_d10km_h_2d_q2_20', num2str(i), '.nc'];
    end
...
for i = 0:14
    ...
    if i < 10
        sFileName = ['har_d10km_h_2d_emiss_200', num2str(i), '.nc'];
    else
        sFileName = ['har_d10km_h_2d_emiss_20', num2str(i), '.nc'];
    end
