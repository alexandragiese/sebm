...
GUI_Input.output_filename = ['/uufs/chpc.utah.edu/common/home/u0929154/Desktop/Glacier_Model/Indus_Glacier_Sensitivity/Results_FLOR_hourly/Results_',GUI_Input.sGCM,'_Glacier_Number_'];
...
% Glacier number (Chhota Shigri = 56076?)
...
%     end
    ...
    if rem(r,30)
        ...
        if strcmp(GUI_Input.sGCM,'HAR')
                ...
                save(['Josh_MB_',GUI_Input.sGCM,'_',GUI_Input.HAR_temp_res,'_temp_save1.mat'])
                
        else
            
            save(['Josh_MB_',GUI_Input.sGCM,'_temp_save1.mat'])
