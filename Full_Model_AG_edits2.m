...
% % Surface temperature: these are equivalent (checked, kept as == 0 to be consistent with rest of code)
    mT_s(mT_s > 0) = 0; %(C)
...
if GUI_Input.threeDsave == 1 % IF BIG
    ...
    save([GUI_Input.output_filename, num2str(iGlacierNumber),'_withSU.mat'])
end
